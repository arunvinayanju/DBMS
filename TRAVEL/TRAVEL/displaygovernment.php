...
<!DOCTYPE html>
<html>
<title>Display Government</title>
	<!-- CSS only -->
...
if($total!=0)
{
	...
	while($result = mysqli_fetch_assoc($data))
	{
		echo "<tr>
				 ...
				 <td>".$result['TAXNO']."</td>
				 <td><a href='updategovernement.php?dn=$result[DEPTNAME]&on=$result[OWNERNO]&tn=$result[TAXNO]'>Edit</a></td>
				 <td><a href='deletegovernment.php?tn=$result[TAXNO]' onclick='return checkdelete()'>Delete</a></td>
			 </tr>";
	}
}
else{
