...
if($total!=0)
{
	...
	while($result = mysqli_fetch_assoc($data))
	{
		echo "<tr>
				 ...
				 <td><a href='updateagent.php?ana=$result[ANAME]&aad=$result[ADDRESS]&ano=$result[ANO]'>Edit</a></td>
				 <td><a href='deleteagent.php?ano=$result[ANO]' onclick='return checkdelete()'>Delete</a></td>
			 </tr>";
	}
}
else{
