		...
		<form action="" method="GET">
			<!-- <div class="contact-form" method="GET" action=""> -->
				...
				<div class="form-group py-2">
				  ...
				  <div class="col-sm-10">
					<input type="TEXT" class="form-control" id="omobile" placeholder="Enter Owner MOBILE" name="omobile">
				  </div>
				</div>
				<div class="form-group py-2"> 
...
if($_GET['Submit'])
{
	...
	{
		$query = "INSERT INTO ownerdts  VALUES ('$on','$ona','$omb','$oad','$bno')";
		$data = mysqli_query($conn,$query);
		if($data)
		{
			echo "THANK YOU FOR INSERTING OWNER DETAILS";
		}
	}
	else
	{
